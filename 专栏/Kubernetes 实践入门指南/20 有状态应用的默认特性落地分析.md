...
InPlaceIfPossible：控制器会优先尝试原地升级 Pod，如果不行再采用重建升级。目前，只有修改 <code>spec.template.metadata.*</code> 和 <code>spec.template.spec.containers[x].image</code> 这些字段才可以走原地升级。
...
<a href="https://docs.projectcalico.org/networking/use-specific-ip">https://docs.projectcalico.org/networking/use-specific-ip</a>
<a href="https://intl.cloud.tencent.com/zh/document/product/457/35249">https://intl.cloud.tencent.com/zh/document/product/457/35249</a>
<a href="https://openkruise.io/zh-cn/docs/advanced_statefulset.html">https://openkruise.io/zh-cn/docs/advanced_statefulset.html</a>
