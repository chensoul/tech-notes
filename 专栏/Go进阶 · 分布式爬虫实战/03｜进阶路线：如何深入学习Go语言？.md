...
在Go进阶的思维导图中，我列出了进阶需要掌握的诸多知识块，请你认真思考这些知识块对一个程序的作用，找到这些知识块的联系，形成属于你的更大的知识图景。
一个手电筒有聚焦和发散两种模式，同样的，现代脑神经科学的研究发现，人的大脑也有聚焦模式（focused mode）和发散模式（diffuse mode）两种思维方式，你认为这种现象是如何指导你的学习的？
