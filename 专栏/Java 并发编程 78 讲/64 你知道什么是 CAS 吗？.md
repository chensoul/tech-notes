...
![img](assets/Cgq2xl6EXp-ASQS-AABhaV6D_TQ117-2553295.png)

假设有两个线程，分别使用两个 CPU，它们都想利用 CAS 来改变右边的变量的值。我们先来看线程 1，它使用 CPU 1，假设它先执行，它期望当前的值是 100，并且想将其改成 150。在执行的时候，它会去检查当前的值是不是 100，发现真的是 100，所以可以改动成功，而当改完之后，右边的值就会从 100 变成 150。![img](assets/Cgq2xl6EXp-AcJwKAABgmaSYNG4278-2553295.png)
...
![img](assets/Ciqah16EXp-Ac5BbAANR0s_rjiA957-2553297.png)
...
![img](assets/Ciqah16EXqCAQxqSAGyEoIG0htQ416-2553323.gif)

在修改完成后，还会打印出“线程Thread 1执行成功”这句话，如下图所示。

![img](assets/Cgq2xl6EXqCAKVESAABkBbWw9Os255-2553296.png)

接下来我们按下左侧的执行按钮，就轮到 Thread 2 了，此时情景就不同了。

![img](assets/Ciqah16EXqCAGkU-AAXHUfh2Ojg469-2553299.png)
...
![img](assets/Cgq2xl6EXqGAXIjrAHWSmMhqo2o719-2553311.gif)
