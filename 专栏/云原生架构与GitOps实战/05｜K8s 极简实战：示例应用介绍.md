...
<a href="https://kind.sigs.k8s.io/docs/user/quick-start/#installation">安装 Kind</a>。
<h2>架构介绍</h2><h3>应用架构</h3><p>我设计的这个示例应用是一套微服务架构的应用，你可以在 GitHub 上获取<a href="https://github.com/lyzhang1999/kubernetes-example">源码</a>，源码目录结构如下：</p><pre><code class="language-powershell">$ ls
