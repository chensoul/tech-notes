...
![img](assets/Ciqc1F_QfyaAFXAQAAD1xkYN7RE683-2552652.png)
...
![img](assets/Ciqc1F_Qfy2ACkrLAAD2DLkc2qw212-2552652.png)
...
![img](assets/Ciqc1F_QfzOAYoshAAD34kLRebs212-2552652.png)
...
![img](assets/CgqCHl_QfzmAT3mBAAD1O9cjB1Q393-2552652.png)
...
![img](assets/Ciqc1F_Qfz6AROaIAAD0oNZDdx0700-2552652.png)
...
![img](assets/CgqCHl_Qf0aASbDHAAD1VJbPv8c632-2552652.png)
...
![img](assets/CgqCHl_Qf1-AWhOjAAD1EwUX7NE880-2552652.png)

同样在 Timed Waiting 中执行 notify() 和 notifyAll() 也是一样的道理，它们会先进入 Blocked 状态，然后抢夺锁成功后，再回到 Runnable 状态。

![img](assets/Ciqc1F_Qf2SAdJKAAAD1noNKR4M217-2552652.png)

当然对于 Timed Waiting 而言，如果它的超时时间到了且能直接获取到锁/join的线程运行结束/被中断/调用了LockSupport.unpark()，会直接恢复到 Runnable 状态，而无需经历 Blocked 状态。

###### Terminated 终止

![img](assets/CgqCHl_Qf2qAPdCTAAD1YUKiI1s598-2552652.png)
