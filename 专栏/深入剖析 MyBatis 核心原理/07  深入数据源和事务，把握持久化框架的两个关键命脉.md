...
![1.png](assets/Cgp9HWApSnyAeZddAADG9kv9Y-c887-2549565.png)

针对不同的 DataSource 实现，MyBatis 提供了不同的工厂实现来进行创建，如下图所示，这是工厂方法模式的一个典型应用场景。

![2.png](assets/CioPOWApSomAM5hXAADlDsSaiAY054-2549565.png)
...
![3.png](assets/CioPOWApSqKAQyYyAAD_0kpOQec437-2549565.png)
...
![5.png](assets/Cgp9HWApSreAMsSEAADxE9_08B0637-2549565.png)
...
![6.png](assets/CioPOWApSyGAb7OzAAFWzMbS1T8710-2549565.png)
