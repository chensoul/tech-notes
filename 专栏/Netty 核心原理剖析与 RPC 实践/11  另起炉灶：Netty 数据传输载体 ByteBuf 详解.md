...
<strong>readerIndex() &amp; writeIndex()</strong>

<p>readerIndex() 返回的是当前的读指针的 readerIndex 位置，writeIndex() 返回的当前写指针 writeIndex 位置。</p>

<strong>markReaderIndex() &amp; resetReaderIndex()</strong>
...
<strong>readByte() &amp; writeByte(int value)</strong>
...
<strong>getByte(int index) &amp; setByte(int index, int value)</strong>
