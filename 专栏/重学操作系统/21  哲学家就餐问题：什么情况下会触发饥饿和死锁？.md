...
<p>死锁有 4 个基本条件。</p>
<ol>
<strong>资源存在互斥逻辑：每次只有一个线程可以抢占到资源</strong>。这里是哲学家抢占叉子。
<strong>持有等待</strong>：这里哲学家会一直等待拿到叉子。
<strong>禁止抢占：如果拿不到资源一直会处于等待状态，而不会释放已经拥有的资源</strong>。
<strong>循环等待</strong>：这里哲学家们会循环等待彼此的叉子。
</ol>
