...
![Drawing 0.png](assets/CgqCHl9htcuAAw51AAK0O_g_pbM862-2552584.png)
...
![Drawing 1.png](assets/CgqCHl9htdiAO89HAAK1NRYCNZE604-2552584.png)

如上图，我们通常使用 Grafana 进行监控数据的展示，使用 AlertManager 组件进行提前预警。这一部分的搭建工作不是我们的重点，感兴趣的同学可自行研究。

下图便是一张典型的监控图，可以看到 Redis 的缓存命中率等情况。

![Drawing 2.png](assets/Ciqc1F9htd-AXIKHAANYYdIDl6g753-2552584.png)
...
![2020-08-21 17-07-35.2020-08-21 17_12_29.gif](assets/Ciqc1F9htfOAN3G1AEK7W4TM0AU264-2552587.gif)
...
![Drawing 4.png](assets/Ciqc1F9htgCAcdwGAAIVQmXnOPo885-2552584.png)
...
![Drawing 5.png](assets/Ciqc1F9htwyARKqMAAgxG3QYe8A553-2552584.png)
...
![Drawing 6.png](assets/CgqCHl9htvaAf1S-AAKlZCq3SXg275-2552584.png)
...
![Drawing 7.png](assets/Ciqc1F9htx6ADeh6AAFoqvxy4eM753-2552584.png)
