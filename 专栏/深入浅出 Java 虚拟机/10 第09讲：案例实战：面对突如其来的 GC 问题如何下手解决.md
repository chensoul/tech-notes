...
![img](assets/CgpOIF49MRaAYy5hAAAxaKab220724-2550008.jpg)
...
![img](assets/Cgq2xl49MRaAZaFKAABeSE1hLTg491-2550008.jpg)
...
![img](assets/CgpOIF49MRaAUrVfAAFWihJ6jwk874-2550008.jpg)
...
![img](assets/Cgq2xl49MRaAWpU-AAAUzFIkYlk730-2550008.jpg)
...
![img](assets/CgpOIF49MRaACSuzAABDthdVxTk570-2550008.jpg)
...
![img](assets/Cgq2xl49MReAI98WAABRPqHhDjE672-2550008.jpg)

你在看这些信息的时候，一定要结合宿主服务器的监控去看。比如 GC 发生期间，CPU 会突然出现尖锋，就证明 GC 对 CPU 资源使用的有点多。但多数情况下，如果吞吐量和延迟在可接受的范围内，这些对 CPU 的超额使用是可以忍受的。

（3）交互式图表

![img](assets/CgpOIF49MReAcKfGAABakc1dRtA053-2550008.jpg)

可以对有问题的区域进行放大查看，图中表示垃圾回收后的空间释放，可以看到效果是比较好的。

（4）G1 的时间耗时

![img](assets/Cgq2xl49MReAf_DdAACM8OnUC_I541-2550008.jpg)
...
![img](assets/CgpOIF49MReAL2goAAB6BiE3imA217-2550008.jpg)
...
![img](assets/Cgq2xl49MReAQIQ_AABZPnGfj9s030-2550008.jpg)

下面这个是典型的内存泄漏。

![img](assets/CgpOIF49MReAQHswAABgRmmPU5k549-2550008.jpg)
...
![img](assets/Cgq2xl49MReAUqsJAABSeq9EGOY088-2550008.jpg)
...
![img](assets/CgpOIF49MReAa5QEAAAoiL0gjR4706-2550008.jpg)
