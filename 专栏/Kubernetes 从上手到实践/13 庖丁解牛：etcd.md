...
进入该 Pod 并查看 <code>etcd</code> 集群的 <code>member</code>
...
使用 <code>kubectl</code> 创建名为 <code>moelove</code> 的 Namespaces
...
<a href="https://etcd.readthedocs.io/en/latest/faq.html#what-is-etcd">What is etcd</a>
