...
<strong>Web 应用：</strong> 可以是各种语言写的，这种可以是使用 Serverless 框架新编写的程序，也可以是已有的应用。比如可能是小程序后端，也可能是 Web API；
<strong>对计算能力有很强的弹性诉求的应用：</strong> 比如 AI 推理、音视频处理、图文转换等；
<strong>事件驱动型的应用：</strong> 比如通过其他阿里云产品驱动的场景，Web Hook、定时任务等。
