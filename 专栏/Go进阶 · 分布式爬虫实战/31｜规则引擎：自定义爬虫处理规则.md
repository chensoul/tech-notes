...
<!-- [[[read_end]]] --><p>为了解决上面这些问题，我们需要有专门负责规则管理的模块，并完成静态规则与动态规则的解析。</p><h2>静态规则引擎</h2><p>静态规则处理的确定性强，它适合对性能要求高的爬虫任务。我们可以把一个任务的规则抽象如下：</p><pre><code class="language-plain">type RuleTree struct {
