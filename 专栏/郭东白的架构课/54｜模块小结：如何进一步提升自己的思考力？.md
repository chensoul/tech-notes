...
<strong>找反例</strong>：通过你自身的观察和经验，也就是终极的实证过程，找到反例，从而发现课程里提到的与事实不符的模型或规律。
<strong>找逻辑缺陷</strong>：对于任何一个结论，都要采用批判思维的方式来发现缺陷。
<strong>找冲突</strong>：寻找课程中的法则或是论断之间互相矛盾的地方，指出其中逻辑不自洽的地方。
