...
![img](assets/CgpOIF4UXzOAEhBUAAGnAhohAII133-2549913.png)
...
![img](assets/Cgq2xl4UXzOAXlI_AAFpK7ghZGQ508-2549913.png)
...
![img](assets/CgpOIF4VvV2AI0nOAAH7mA63_GA021-2549913.png)

![img](assets/CgpOIF4VvWaASjTZAAKdf712E44111-2549913.png)

对比这两张图可以看到 C++ 程序是编译成操作系统能够识别的 .exe 文件，而 Java 程序是编译成 JVM 能够识别的 .class 文件，然后由 JVM 负责调用系统函数执行程序。

### JVM、JRE、JDK的关系

![img](assets/CgpOIF4UXzOAWjoYAAB_bUtfWsU572-2549913.png)
...
![img](assets/Cgq2xl4UXzOAWEn7AACdFd2H7HA713-2549913.png)
...
![img](assets/CgpOIF4UXzOAbzFUAAAhKnX7ea0980-2549913.png)
...
![img](assets/Cgq2xl4UXzSATBgMAAG_3NHMI_Y236-2549913.png)
