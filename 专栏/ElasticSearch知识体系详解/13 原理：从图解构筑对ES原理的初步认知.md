...
为什么我的搜索 <code>*foo-bar*</code> 无法匹配 <code>foo-bar</code> ？
...
<strong>查询“the fury”</strong>

<p><img src="assets/es-th-1-10.png" alt="img" /></p>

<strong>自动补全</strong>（AutoCompletion-Prefix）
...
<ol>
<code>* suffix -&gt; xiffus *</code>
</ol>
<p>如果我们想以后缀作为搜索条件，可以为Term做反向处理。</p>
<ol>
<code>(60.6384, 6.5017) -&gt; u4u8gyykk</code>
</ol>
<p>对于GEO位置信息，可以将它转换为GEO Hash。</p>
<ol>
<code>123 -&gt; {1-hundreds, 12-tens, 123}</code>
</ol>
<p>对于简单的数字，可以为它生成多重形式的Term。</p>

<strong>解决拼写错误</strong>
