...
<strong>建设复盘氛围</strong>：为参与者提供一个安全且平衡的复盘环境。
<strong>梳理错失的机会点</strong>：从公司层面的宏观视角看，错失的最可惜的机会点是什么？提前梳理重大机会点，可以帮助我们控制复盘节奏，避免复盘成为一个裸心会，被一个麦霸引导到他个人的心灵独白中去。
<strong>设定目标：</strong>引导参会者对复盘目标有个清晰的认知。如果不能拿到一个非常有洞察的、能真正提升未来成功概率的结论和行动点，那么复盘就不能结束。
