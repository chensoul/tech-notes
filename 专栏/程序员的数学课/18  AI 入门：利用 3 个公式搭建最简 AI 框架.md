...
第一步，根据假设，写出模型的输入、输出关系 y = f(<em><strong>w</strong></em>; x)；
第二步，根据偏差的计算方法，写出描述偏差的损失函数 L(<em><strong>w</strong></em>)；
第三步，对于损失函数，求解最优的参数值，即<em><strong>w</strong></em>*= argmin L(<em><strong>w</strong></em>)。
...
第二步的损失函数，可以由平方误差调整为绝对值求和的误差，即 L(<em><strong>w</strong></em>) = |y1 - ŷ1| + |y2 - ŷ2| + |y3 - ŷ3|；
...
第一步，根据假设，写出模型的输入、输出关系 y = f(<em><strong>w</strong></em>; x)。我们假设是线性模型，则有

<p>y = kx + b。</p>

第二步，根据偏差的计算方法，写出描述偏差的损失函数 L(<em><strong>w</strong></em>)。我们选择平方误差，则有
...
第三步，对于损失函数，求解最优的参数值，即<em><strong>w</strong></em>*= argmin L(<em><strong>w</strong></em>)。为了求解函数的极小值，我们考虑计算损失函数关于 k 和 b 的导数，则有
...
第一步，根据假设，写出模型的输入输出关系 y = f(<em><strong>w</strong></em>; x)；
第二步，根据偏差的计算方法，写出描述偏差的损失函数 L(<em><strong>w</strong></em>)；
第三步，对于损失函数，求解最优的参数值，即<em><strong>w</strong></em>*= argmin L(<em><strong>w</strong></em>)。
