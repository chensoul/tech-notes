...
![enter image description here](assets/0b5a9de0-cfad-11e8-8388-bd48f25029c6.png)
...
props.put(“acks”, “all”); //保证高可靠性，设置成”all”或者”-1” props.put(“retries”, 3); 
//重试次数阈值，这里设置为3 
...
props.put(“bootstrap.servers”, “100.120.160.170:9092,100.120.160.171:9092, 100.120.160.172:9092”); props.put(“acks”, “all”); 
// 高可靠性要求则应该设置成”all” 
...
Kafka 的 Java 客户端 Kafka Clients，自版本 0.10.0.0 起，接收消息的线程更改为单线程。同时，对于 Consumer 的 Offset，默认情况下，客户端采用的是自动提交模式，由参数 `enable.auto.commit` 控制。
