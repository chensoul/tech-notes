...
![img](assets/b7226350-68cd-11ea-b561-436a0f360bc4.jpeg)
...
![img](assets/96481700-68ce-11ea-bc7d-05803d82869a.jpeg)

可以看到检测到了内存问题。

**2. JVM 内存大小分析**

![img](assets/a577e070-68ce-11ea-ae6a-117f7e51795f.jpeg)
...
![img](assets/0da8eed0-68d1-11ea-bb52-d9f36e195645.jpeg)

**4. GC 之后的内存情况统计**

GC 执行以后堆内存的使用情况。

![img](assets/05899e20-68d1-11ea-b5b9-6ffe049fb524.jpeg)

**5. GC 情况汇总统计信息**

可以看到 Full GC 是影响性能的绝对大头。

![img](assets/f8550870-68d0-11ea-a490-d3e65769b9bf.jpeg)

![img](assets/f183e2a0-68d0-11ea-ba47-f5157949cfb6.jpeg)

**6. 内存分配速度**

内存分配的速度越快，说明我们程序里创建对象越频繁。

![img](assets/e9d6dbc0-68d0-11ea-ae7c-7719cd808daa.jpeg)

**7. 内存泄漏、长暂停、安全点等信息**

没有检测到内存泄漏。

![img](assets/dfa39f30-68d0-11ea-ba47-f5157949cfb6.jpeg)

**8. GC 原因汇总**

可以看到 GC 发生的原因，其中 566 次是 GC 策略自己调整的（Ergonomics），32 次是因为分配失败导致的。

![img](assets/ce73e710-68d0-11ea-9d64-851af22d0044.jpeg)

**9. 其他信息**

![img](assets/c0830640-68d0-11ea-bb52-d9f36e195645.jpeg)
...
![img](assets/889b0b10-68d0-11ea-ae6a-117f7e51795f.jpeg)
...
![img](assets/7e0f9c60-68d0-11ea-a6a7-51d4d3ff7d7c.jpeg)
...
![img](assets/5c2f2020-68d0-11ea-b561-436a0f360bc4.jpeg)
...
![img](assets/41f5b750-68d0-11ea-bb52-d9f36e195645.jpeg)
...
![img](assets/2a10c5d0-68d0-11ea-ae6a-117f7e51795f.jpeg)
