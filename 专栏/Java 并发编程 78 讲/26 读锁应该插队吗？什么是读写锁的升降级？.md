...
![img](assets/Cgq2xl4O9CeAAEoOAAB1ZPyf3Ow995-2552880.png)面对这种情况有两种应对策略：
...
![img](assets/Cgq2xl4O9F2AR8XVAACUtGWSKRc535-2552880.png)

### 第二种策略：不允许插队

这种策略认为由于线程 3 已经提前等待了，所以虽然线程 5 如果直接插队成功，可以提高效率，但是我们依然让线程 5 去排队等待：

![img](assets/Cgq2xl4O9HuAXiW4AAB6t9JMFr0558-2552880.png)按照这种策略线程 5 会被放入等待队列中，并且排在线程 3 的后面，让线程 3 优先于线程 5 执行，这样可以避免“饥饿”状态，这对于程序的健壮性是很有好处的，直到线程 3 运行完毕，线程 5 才有机会运行，这样谁都不会等待太久的时间。

![img](assets/CgpOIF4O9KGALnpFAABNXz5a77Q914-2552880.png)
